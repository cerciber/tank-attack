...
public final class Tablero {
    ...
    Objeto textoPausa = new Objeto(800/2-150/2, 600/2-50/2, 150, 50, 
            "/tankattack/imagenes/muro/pausa.png");
    Objeto volver = new Objeto(0, 600-80, 100, 50, 
        "/tankattack/imagenes/configuracion/img7.png");
    
    AudioClip audioBatalla = java.applet.Applet.newAudioClip(getClass().getResource("/tankattack/audios/Batalla.wav"));
    AudioClip audioGolpeBala = java.applet.Applet.newAudioClip(getClass().getResource("/tankattack/audios/golpeBala.wav"));
    AudioClip audioMuroRoto = java.applet.Applet.newAudioClip(getClass().getResource("/tankattack/audios/romperMuro.wav"));
    AudioClip audioGanarPunto = java.applet.Applet.newAudioClip(getClass().getResource("/tankattack/audios/ganarPunto.wav"));
    ...
    public void eventos(MouseEvent me) {
        ...
        if(!pausa){
            ...
            if(volver.click(me)){
                escenario.menuPrincipal.cambiarPantalla = 0;
                audioBatalla.stop();
                escenario.menuPrincipal.pantallaDePresentacion.gameLoop.sonidoDeFondo.play();
            }
